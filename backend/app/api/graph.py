...
# Initialize logger
logger = get_logger('homepty_swarm.api')
...
def generate_ontology():
    """
    API 1: Upload files and analyze to generate ontology definitions.
...
def build_graph():
    ...
    try:
        ...
        # Get configuration
        graph_name = data.get('graph_name', project.name or 'Homepty Swarm Graph')
        ...
        def build_task():
            ...
            build_logger = get_logger('homepty_swarm.build')
            try:
