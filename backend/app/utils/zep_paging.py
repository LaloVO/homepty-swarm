...
This module encapsulates the auto-pagination logic (with per-page retries),
...
logger = get_logger('homepty_swarm.zep_paging')
...
def fetch_all_nodes(
    ...
    """Paginate and fetch graph nodes, returning at most max_items (default 2000). Each page request includes retry logic."""
    all_nodes: list[Any] = []
...
def fetch_all_edges(
    ...
    """Paginate and fetch all graph edges, returning a complete list. Each page request includes retry logic."""
    all_edges: list[Any] = []
    cursor: str | None = None
    page_num = 0
