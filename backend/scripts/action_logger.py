"""
Action Logger
Records each agent's actions in an OASIS simulation for backend monitoring.
...
class SimulationLogManager:
    ...
    Manages all log files uniformly, split by platform.
    """
...
class ActionLogger:
    ...
    SimulationLogManager is recommended instead.
    """
