...
logger = get_logger('homepty_swarm.simulation_ipc')
...
class SimulationIPCClient:
    """
    Simulation IPC Client (Used by Flask end)
    ...
    def send_command(
        ...
        Raises:
            TimeoutError: Wait for response timeout
        """
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specified platform (optional)
                ...
                - None: Interview both platforms if dual platform simulation, else the single platform
            timeout: Timeout
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, will be overridden by each interview item's platform)
                ...
                - None: Interview both platforms for each Agent if dual platform simulation
            timeout: Timeout
    ...
    def check_env_alive(self) -> bool:
        ...
        Judged by checking env_status.json file
        """
...
class SimulationIPCServer:
    """
    Simulation IPC Server (Used by simulation script end)
    ...
    def start(self):
        """Mark server as running status"""
        self._running = True
        self._update_env_status("alive")
    
    def stop(self):
        """Mark server as stopped status"""
        self._running = False
