...
// Directly get maxRounds from query parameters during initialization to ensure child components get the value immediately
...
const handleNextStep = () => {
  // Step3Simulation component handles report generation and navigation directly
...
const loadGraph = async (graphId) => {
  // Do not show full-screen loading when simulating to prevent flickering
...
onMounted(() => {
  ...
  // Log maxRounds config (value already obtained from query parameters)
  if (maxRounds.value) {
