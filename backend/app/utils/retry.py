...
logger = get_logger('homepty_swarm.retry')
...
class RetryableAPIClient:
    ...
    def call_batch_with_retry(
        ...
        """
        Batch call and retry for each failed item individually
        
        Args:
            items: List of items to process
            process_func: Process function, receives a single item as argument
            exceptions: Exception types to retry
