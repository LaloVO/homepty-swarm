...
def _ensure_utf8_stdout():
    ...
    Resolves non-ASCII character display issues in Windows console.
    """
...
def setup_logger(name: str = 'homepty_swarm', level: int = logging.DEBUG) -> logging.Logger:
    """
    Setup logging.
...
def get_logger(name: str = 'homepty_swarm') -> logging.Logger:
    """
